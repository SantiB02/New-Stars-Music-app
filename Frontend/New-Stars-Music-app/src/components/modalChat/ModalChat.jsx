            ...
            case '3':
                response = (
                    <ul className="list-disc pl-5">
                        ...
                        <li>Refunds: Refunds are processed to the original payment method.</li>
                        <li>Conditions: The item must be in its original, unused condition.</li>
                    </ul>
                );
                break;
            default:
    ...
    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg w-80 relative">
                ...
                <h2 className="text-xl mb-4">Chat with Us</h2>
