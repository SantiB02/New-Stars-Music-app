...
namespace Merchanmusic.Migrations
{
    ...
    [Migration("20240709224724_added Category entity and link it to Product")]
    partial class addedCategoryentityandlinkittoProduct
    {
            ...
            modelBuilder.Entity("Merchanmusic.Data.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "1022",
                            CreationDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8600),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8612),
                            Name = "Remera ACDC",
                            Price = 12500.71m,
                            Sales = 237,
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "18az4",
                            CreationDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8621),
                            Description = "Remera Mozart algodón",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8621),
                            Name = "Remera Mozart",
                            Price = 23763.34m,
                            Sales = 129,
                            SellerId = "default-identifier-7771829382",
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "17zz89",
                            CreationDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8624),
                            Description = "Remera Beethoven algodón",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8624),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "ax34d",
                            CreationDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8627),
                            Description = "Remera overside negra",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 9, 19, 47, 23, 510, DateTimeKind.Local).AddTicks(8627),
                            Name = "Remera LOVG",
                            Price = 13200.11m,
                            Sales = 421,
                            SellerId = "default-identifier-7771829382",
