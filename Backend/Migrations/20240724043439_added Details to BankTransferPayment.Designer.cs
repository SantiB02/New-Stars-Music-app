...
namespace Merchanmusic.Migrations
{
    ...
    [Migration("20240724043439_added Details to BankTransferPayment")]
    partial class addedDetailstoBankTransferPayment
    {
            ...
            modelBuilder.Entity("Merchanmusic.Data.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(4508),
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(4507),
            ...
            modelBuilder.Entity("Merchanmusic.Data.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "1022",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5776),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5779),
                            Name = "Remera ACDC",
                            Price = 12500.71m,
                            Sales = 237,
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "18az4",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5784),
                            Description = "Remera Mozart algodón",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5785),
                            Name = "Remera Mozart",
                            Price = 23763.34m,
                            Sales = 129,
                            SellerId = "default-identifier-7771829382",
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "17zz89",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5787),
                            Description = "Remera Beethoven algodón",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5787),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Code = "ax34d",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5789),
                            Description = "Remera overside negra",
                            ImageLink = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Semi_dry_suit_-_2604.png/256px-Semi_dry_suit_-_2604.png?20180603115529",
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5790),
                            Name = "Remera LOVG",
                            Price = 13200.11m,
                            Sales = 421,
                            SellerId = "default-identifier-7771829382",
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            Code = "e52x6",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5792),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5793),
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            Code = "45hgr",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5795),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5795),
                        ...
                        new
                        {
                            ...
                            CategoryId = 4,
                            Code = "46as3",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5797),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5798),
                            Name = "Avicii bag",
                            Price = 15900.45m,
                            Sales = 128,
                            SellerId = "default-identifier-7771829382",
                        ...
                        new
                        {
                            ...
                            CategoryId = 5,
                            Code = "76fg1",
                            CreationDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5800),
                            ...
                            LastModifiedDate = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(5800),
            ...
            modelBuilder.Entity("Merchanmusic.Data.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinedOn = new DateTime(2024, 7, 24, 1, 34, 39, 49, DateTimeKind.Local).AddTicks(4470)
                        });
                });
            ...
            modelBuilder.Entity("Merchanmusic.Data.Payments.Payment", b =>
                {
                    ...
                    b.HasOne("Merchanmusic.Data.Entities.Seller", "Receiver")
                        .WithMany()
