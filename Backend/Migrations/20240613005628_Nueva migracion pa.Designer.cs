...
namespace Merchanmusic.Migrations
{
    ...
    [Migration("20240613005628_Nueva migracion pa")]
    partial class Nuevamigracionpa
    {
            ...
            modelBuilder.Entity("Merchanmusic.Data.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "T-shirt",
                            Code = "1022",
                            CreationDate = new DateTime(2024, 6, 12, 21, 56, 28, 626, DateTimeKind.Local).AddTicks(5287),
                            Description = "Remera ACDC algodón",
                            ImageLink = "##",
                            LastModifiedDate = new DateTime(2024, 6, 12, 21, 56, 28, 626, DateTimeKind.Local).AddTicks(5299),
                            Name = "Remera ACDC",
                            Price = 12500m,
                            State = true,
                            Stock = 10
                        ...
                        new
                        {
                            ...
                            Category = "T-shirt",
                            Code = "1021",
                            CreationDate = new DateTime(2024, 6, 12, 21, 56, 28, 626, DateTimeKind.Local).AddTicks(5305),
                            Description = "Remera overside negra",
                            ImageLink = "$$",
                            LastModifiedDate = new DateTime(2024, 6, 12, 21, 56, 28, 626, DateTimeKind.Local).AddTicks(5306),
                            Name = "Remera LOVG",
                            Price = 13200m,
                            State = true,
                            Stock = 15
